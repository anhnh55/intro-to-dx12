...
LightingDemo::LightingDemo(HINSTANCE hInstance)
	: D3DApp(hInstance)
{
...
void LightingDemo::Update(const GameTimer& gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void LightingDemo::Draw(const GameTimer& gt)
{
...
void LightingDemo::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
void LightingDemo::OnKeyboardInput(const GameTimer& gt)
{
...
void LightingDemo::UpdateCamera(const GameTimer& gt)
{
...
void LightingDemo::UpdateWaves(const GameTimer& gt)
{
...
void LightingDemo::BuildInputLayout()
{
...
void LightingDemo::BuildRootSignature()
{
...
void LightingDemo::CompileShaders()
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\default.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\default.hlsl", nullptr, "PS", "ps_5_1");
}

void LightingDemo::BuildPSO()
{
...
void LightingDemo::BuildFrameResources()
{
...
void LightingDemo::UpdateObjectCBs(const GameTimer& gt)
{
...
void LightingDemo::UpdateMainPassCB(const GameTimer& gt)
{
...
void LightingDemo::UpdateMaterialCBs(const GameTimer& gt)
{
...
float LightingDemo::GetHillsHeight(float x, float z)
{
	return 0.3f * (z * sinf(0.1f * x) + x * cosf(0.1f * z));
}

XMFLOAT3 LightingDemo::GetHillsNormal(float x, float z) const
{
	// n = (-df/dx, 1, -df/dz)
...
void LightingDemo::BuildLandGeometry()
{
...
void LightingDemo::BuildMaterials()
{
...
void LightingDemo::BuildRenderItems()
{
