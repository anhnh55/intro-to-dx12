...
TextureDemo::TextureDemo(HINSTANCE hInstance)
	: D3DApp(hInstance)
{
	mMainWndCaption = L"Texture Demo";
}
...
void TextureDemo::Update(const GameTimer& gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void TextureDemo::Draw(const GameTimer& gt)
{
...
void TextureDemo::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
void TextureDemo::OnKeyboardInput(const GameTimer& gt)
{
...
void TextureDemo::UpdateCamera(const GameTimer& gt)
{
...
void TextureDemo::UpdateWaves(const GameTimer& gt)
{
...
void TextureDemo::BuildInputLayout()
{
...
void TextureDemo::CompileShaders()
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\default.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\default.hlsl", nullptr, "PS", "ps_5_1");
}

void TextureDemo::BuildPSO()
{
...
void TextureDemo::UpdateObjectCBs(const GameTimer& gt)
{
...
void TextureDemo::UpdateMainPassCB(const GameTimer& gt)
{
...
void TextureDemo::UpdateMaterialCBs(const GameTimer& gt)
{
...
float TextureDemo::GetHillsHeight(float x, float z)
{
	return 0.3f * (z * sinf(0.1f * x) + x * cosf(0.1f * z));
}

XMFLOAT3 TextureDemo::GetHillsNormal(float x, float z) const
{
	// n = (-df/dx, 1, -df/dz)
...
void TextureDemo::LoadTextures()
{
	...
	fenceTex->Filename = L"../../../Textures/WoodCrate01 - Copy.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
...
void TextureDemo::BuildLandGeometry()
{
...
void TextureDemo::BuildWavesGeometryBuffers()
{
...
void TextureDemo::AnimateMaterials(const GameTimer& gt)
{
