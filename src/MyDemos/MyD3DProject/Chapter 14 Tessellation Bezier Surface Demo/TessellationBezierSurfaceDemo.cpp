#include "TessellationBezierSurfaceDemo.h"
#include "d3d12.h"
...
TessellationBezierSurfaceDemo::TessellationBezierSurfaceDemo(HINSTANCE hInstance)
	: D3DApp(hInstance)
{
	mMainWndCaption = L"Tessellation Quad Demo";
}

TessellationBezierSurfaceDemo::~TessellationBezierSurfaceDemo()
{

}

bool TessellationBezierSurfaceDemo::Initialize()
{
...
void TessellationBezierSurfaceDemo::OnResize()
{
...
void TessellationBezierSurfaceDemo::Update(const GameTimer& gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void TessellationBezierSurfaceDemo::Draw(const GameTimer& gt)
{
...
void TessellationBezierSurfaceDemo::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
void TessellationBezierSurfaceDemo::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void TessellationBezierSurfaceDemo::OnMouseUp(WPARAM btnState, int x, int y)
{
	//release mouse capture when mouse is released
	ReleaseCapture();
}

void TessellationBezierSurfaceDemo::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void TessellationBezierSurfaceDemo::OnKeyboardInput(const GameTimer& gt)
{
...
void TessellationBezierSurfaceDemo::UpdateCamera(const GameTimer& gt)
{
...
void TessellationBezierSurfaceDemo::BuildInputLayout()
{
...
void TessellationBezierSurfaceDemo::BuildRootSignature()
{
...
void TessellationBezierSurfaceDemo::CompileShaders()
{
...
void TessellationBezierSurfaceDemo::BuildPSO()
{
...
void TessellationBezierSurfaceDemo::BuildFrameResources()
{
...
void TessellationBezierSurfaceDemo::UpdateObjectCBs(const GameTimer& gt)
{
...
void TessellationBezierSurfaceDemo::UpdateMainPassCB(const GameTimer& gt)
{
...
void TessellationBezierSurfaceDemo::UpdateMaterialCBs(const GameTimer& gt)
{
...
void TessellationBezierSurfaceDemo::BuildQuadPatchGeometry()
{
...
void TessellationBezierSurfaceDemo::BuildMaterials()
{
...
void TessellationBezierSurfaceDemo::BuildRenderItems()
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> TessellationBezierSurfaceDemo::GetStaticSamplers()
{
