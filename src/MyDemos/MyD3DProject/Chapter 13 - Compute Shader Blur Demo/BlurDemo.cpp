...
void BlurDemo::Update(const GameTimer& gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void BlurDemo::Draw(const GameTimer& gt)
{
...
void BlurDemo::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
void BlurDemo::OnKeyboardInput(const GameTimer& gt)
{
...
void BlurDemo::UpdateCamera(const GameTimer& gt)
{
...
void BlurDemo::UpdateWaves(const GameTimer& gt)
{
...
void BlurDemo::BuildFrameResources()
{
...
void BlurDemo::UpdateObjectCBs(const GameTimer& gt)
{
...
void BlurDemo::UpdateMainPassCB(const GameTimer& gt)
{
...
void BlurDemo::UpdateMaterialCBs(const GameTimer& gt)
{
...
float BlurDemo::GetHillsHeight(float x, float z)
{
...
void BlurDemo::LoadTextures()
{
	...
	//
	CD3DX12_CPU_DESCRIPTOR_HANDLE descriptorHandle(mCbvSrvUavDescriptorHeap->GetCPUDescriptorHandleForHeapStart());
...
void BlurDemo::BuildLandGeometry()
{
...
void BlurDemo::BuildBoxGeometry()
{
	GeometryGenerator geoGen;
...
void BlurDemo::BuildWavesGeometryBuffers()
{
...
void BlurDemo::BuildRenderItems()
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> BlurDemo::GetStaticSamplers()
{
...
void BlurDemo::AnimateMaterials(const GameTimer& gt)
{
