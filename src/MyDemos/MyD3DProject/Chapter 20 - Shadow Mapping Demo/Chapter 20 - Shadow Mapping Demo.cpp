//***************************************************************************************
// ShadowMappingDemoApp.cpp by Frank Luna (C) 2015 All Rights Reserved.
//***************************************************************************************
...
class ShadowMappingDemoApp : public D3DApp
{
public:
	ShadowMappingDemoApp(HINSTANCE hInstance);
	ShadowMappingDemoApp(const ShadowMappingDemoApp& rhs) = delete;
	ShadowMappingDemoApp& operator=(const ShadowMappingDemoApp& rhs) = delete;
    ~ShadowMappingDemoApp();
...
private:
	...
	XMFLOAT3 mLightPosW; //light pos (world coord)
	//near and far plane of light view frustum 
    ...
    PSTR cmdLine, int showCmd)
{
    ...
    try
    {
		ShadowMappingDemoApp theApp(hInstance);
...
ShadowMappingDemoApp::ShadowMappingDemoApp(HINSTANCE hInstance)
    : D3DApp(hInstance)
{
...
ShadowMappingDemoApp::~ShadowMappingDemoApp()
{
    if(md3dDevice != nullptr)
        FlushCommandQueue();
}

bool ShadowMappingDemoApp::Initialize()
{
...
void ShadowMappingDemoApp::CreateRtvAndDsvDescriptorHeaps()
{
...
void ShadowMappingDemoApp::OnResize()
{
    D3DApp::OnResize();
...
void ShadowMappingDemoApp::Update(const GameTimer& gt)
{
	OnKeyboardInput(gt);
...
void ShadowMappingDemoApp::UpdateShadowPassCB(const GameTimer& gt)
{
...
void ShadowMappingDemoApp::OnMouseDown(WPARAM btnState, int x, int y)
{
    mLastMousePos.x = x;
    mLastMousePos.y = y;
...
void ShadowMappingDemoApp::OnMouseUp(WPARAM btnState, int x, int y)
{
    ReleaseCapture();
}

void ShadowMappingDemoApp::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void ShadowMappingDemoApp::OnKeyboardInput(const GameTimer& gt)
{
...
void ShadowMappingDemoApp::AnimateMaterials(const GameTimer& gt)
{
	
}

void ShadowMappingDemoApp::UpdateObjectCBs(const GameTimer& gt)
{
...
void ShadowMappingDemoApp::UpdateMaterialBuffer(const GameTimer& gt)
{
...
void ShadowMappingDemoApp::UpdateMainPassCB(const GameTimer& gt)
{
...
void ShadowMappingDemoApp::UpdateShadowTransform(const GameTimer& gt)
{
	...
	XMFLOAT3 sphereCenterLS;//sphere center in light space
	...
	//matrix to transform a point from world space to light view texture space = lightview*lightProj*T
...
void ShadowMappingDemoApp::DrawSceneToShadowMap()
{
...
void ShadowMappingDemoApp::BuildShapeGeometry()
{
...
void ShadowMappingDemoApp::BuildSkullGeometry()
{
...
void ShadowMappingDemoApp::BuildMaterials()
{
...
void ShadowMappingDemoApp::BuildRenderItems()
{
...
void ShadowMappingDemoApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 7> ShadowMappingDemoApp::GetStaticSamplers()
{
